try {
  ...
  (function () {
    ...
    window.sessionStorage.prototype = window.sessionStorage = new Storage(
      "session"
    );
  })();
}
...
ctx.nameToUrl = function () {
  ...
  if (
    ...
    !url.match(/\.authorize\.net\/v1\/Accept/) &&
    !url.match(/https:\/\/www.google.com\/recaptcha\/api.js/)
  ) {
...
(function (require) {
  ...
  (function () {
    var config = {
      shim: { "tiny_mce_4/tinymce.min": { exports: "tinyMCE" } },
  ...
  (function () {
    var config = {
      ...
      shim: { paypalInContextExpressCheckout: { exports: "paypal" } },
    };
    require.config(config);
  })();
  (function () {
  ...
  (function () {
    var config = {
      shim: {
        acceptjs: { exports: "Accept" },
        acceptjssandbox: { exports: "Accept" },
      },
      paths: {
  ...
  (function () {
    var config = {
      map: {
        "*": {
          braintreeClient:
            "https://js.braintreegateway.com/web/3.48.0/js/client.min.js",
          braintreeHostedFields:
            "https://js.braintreegateway.com/web/3.48.0/js/hosted-fields.min.js",
          braintreePayPal:
            "https://js.braintreegateway.com/web/3.48.0/js/paypal-checkout.min.js",
          braintree3DSecure:
            "https://js.braintreegateway.com/web/3.48.0/js/three-d-secure.min.js",
          braintreeDataCollector:
            "https://js.braintreegateway.com/web/3.48.0/js/data-collector.min.js",
        },
      },
      paths: {
        braintreePayPalCheckout:
          "https://www.paypalobjects.com/api/checkout.min",
      },
      shim: { braintreePayPalCheckout: { exports: "paypal" } },
    };
    require.config(config);
  })();
  (function () {
  ...
  (function () {
    var config = {
      map: { "*": {} },
      paths: { "acx/brandslider": "Acx_BrandSlider/js/flexslider-min" },
      shim: { "acx/brandslider": { deps: ["jquery"] } },
    };
    require.config(config);
  })();
  (function () {
  ...
  (function () {
    var config = {
      paths: { mgswow: "js/wow.min" },
      shim: { wow: { deps: ["jquery"] } },
    };
    require.config(config);
  })();
  (function () {
    var config = {
      map: { "*": { lazysizes: "Fisheye_Lazyload/js/lazysizes.min" } },
      deps: ["lazysizes", "Fisheye_Lazyload/js/ls.native-loading.min"],
      shim: { "Fisheye_Lazyload/js/lazysizes.min": { exports: "lazySizes" } },
    };
    require.config(config);
  })();
  (function () {
    var config = {
      map: {
        "*": {
          ...
          popper: "Hiddentechies_Bentriz/js/popper.min",
          bootstrap4: "Hiddentechies_Bentriz/js/bootstrap.bundle.min",
        },
        shim: {
          popper: { deps: ["jquery"] },
          bootstrap4: { deps: ["jquery"] },
        },
      },
    };
    require.config(config);
  ...
  (function () {
    var config = {
      paths: { mpLayer: "Mageplaza_LayeredNavigation/js/view/layer" },
      shim: { mpLayer: ["touchPunch"] },
    };
    require.config(config);
  })();
  (function () {
      ...
      map: {
        "*": {
          swissupTestimonialsList:
            "Swissup_Testimonials/js/Swissup/testimonials/testimonials-list",
        },
      },
    };
    require.config(config);
  ...
  (function () {
    var config = {
      ...
      paths: {
        slick: "assets/slick/slick.min",
        owlcarousel: "assets/js/owl.carousel.min.js",
      },
      shim: { slick: { deps: ["jquery"] }, owlcarousel: { deps: ["jquery"] } },
    };
    require.config(config);
  })();
  (function () {
  ...
  (function () {
    var config = {
      ...
      shim: {
        ...
        owl_config: { deps: ["jquery", "owl_carousel"] },
        owlAjax: { deps: ["jquery", "owl_carousel", "owl_config"] },
      },
    };
    require.config(config);
  })();
  ...
  (function () {
    var config = { map: { "*": { wow: "js/wow/wow.min" } } };
    require.config(config);
  })();
})(require);
